...
public abstract class abstarctSolution<T, P extends Problem<?>> implements Solution<T> {
    String Id;
    protected P problem;
    ...
    public abstarctSolution() {
    }
    protected abstarctSolution(P problem) {
    ...
    private boolean equalsIgnoringAttributes(Object o) {
        if (this == o) {
            ...
            abstarctSolution<?, ?> that = (abstarctSolution)o;
                ...
                while(var3.hasNext()) {
                    ...
                    if (value != valueThat) {
                        ...
                        if (value instanceof AbstractGenericSolution) {
                            areAttributeValuesEqual = ((abstarctSolution)value).equalsIgnoringAttributes(valueThat);
                        } else {
